 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrInstance get() const noexcept {
        return val_;
    }
/*!
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getInstanceProcAddr (
    const char* name, PFN_xrVoidFunction* function, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetInstanceProcAddr enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyInstance enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetInstanceProperties>
 * 
 * @xrentity{xrGetInstanceProperties}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getInstanceProperties (
    InstanceProperties& instanceProperties, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result pollEvent (
    EventDataBuffer& eventData, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrPollEvent enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::EventUnavailable, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPollEvent>
 * 
 * @xrentity{xrPollEvent}
...
Result resultToString (
    Result value, char buffer[XR_MAX_RESULT_STRING_SIZE], Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrResultToString enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrStructureTypeToString>
 * 
 * @xrentity{xrStructureTypeToString}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result structureTypeToString (
    StructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE], Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrStructureTypeToString enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSystem (
    const SystemGetInfo& getInfo, SystemId systemId, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SystemId> getSystem (
        const SystemGetInfo& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
Result getSystemProperties (
    SystemId systemId, SystemProperties& properties, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateEnvironmentBlendModes>
 * 
 * @xrentity{xrEnumerateEnvironmentBlendModes}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateEnvironmentBlendModes (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateEnvironmentBlendModes}
 */
    template <typename Allocator = std::allocator<EnvironmentBlendMode>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<EnvironmentBlendMode, Allocator>> enumerateEnvironmentBlendModesToVector (
        SystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateEnvironmentBlendModes enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 ...
 * @xrentity{xrEnumerateEnvironmentBlendModes}
 */
    template <typename Allocator = std::allocator<EnvironmentBlendMode>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<EnvironmentBlendMode, Allocator>> enumerateEnvironmentBlendModesToVector (
...
Result createSession (
    const SessionCreateInfo& createInfo, Session& session, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Session> createSession (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateViewConfigurations>
 * 
 * @xrentity{xrEnumerateViewConfigurations}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateViewConfigurations (
    SystemId systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateViewConfigurations}
 */
    template <typename Allocator = std::allocator<ViewConfigurationType>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrEnumerateViewConfigurations}
 */
    template <typename Allocator = std::allocator<ViewConfigurationType>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ViewConfigurationType, Allocator>> enumerateViewConfigurationsToVector (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetViewConfigurationProperties>
 * 
 * @xrentity{xrGetViewConfigurationProperties}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getViewConfigurationProperties (
    SystemId systemId, ViewConfigurationType viewConfigurationType, ViewConfigurationProperties& configurationProperties, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateViewConfigurationViews>
 * 
 * @xrentity{xrEnumerateViewConfigurationViews}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateViewConfigurationViews (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateViewConfigurationViews}
 */
    template <typename Allocator = std::allocator<ViewConfigurationView>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ViewConfigurationView, Allocator>> enumerateViewConfigurationViewsToVector (
        SystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateViewConfigurationViews enhanced wrapper.
 * 
 ...
 * @xrentity{xrEnumerateViewConfigurationViews}
 */
    template <typename Allocator = std::allocator<ViewConfigurationView>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ViewConfigurationView, Allocator>> enumerateViewConfigurationViewsToVector (
        SystemId systemId, ViewConfigurationType viewConfigurationType, Allocator const& vectorAllocator, Dispatch&& d) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result stringToPath (
    const char* pathString, Path path, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Path> stringToPath (
        const char* pathString, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result pathToString (
    Path path, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrPathToString}
 */
    template <typename Allocator = std::allocator<char>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrPathToString}
 */
    template <typename Allocator = std::allocator<char>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<string_with_allocator<Allocator>> pathToString (
...
Result createActionSet (
    const ActionSetCreateInfo& createInfo, ActionSet& actionSet, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<ActionSet> createActionSet (
        const ActionSetCreateInfo& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSuggestInteractionProfileBindings>
 * 
 * @xrentity{xrSuggestInteractionProfileBindings}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result suggestInteractionProfileBindings (
    const InteractionProfileSuggestedBinding& suggestedBindings, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSuggestInteractionProfileBindings enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetOpenGLGraphicsRequirementsKHR>
 * 
 * @xrentity{xrGetOpenGLGraphicsRequirementsKHR}
 * 
 * @note Non-core function: needs a dynamic dispatch.
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getOpenGLGraphicsRequirementsKHR (
    SystemId systemId, GraphicsRequirementsOpenGLKHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetOpenGLESGraphicsRequirementsKHR>
 * 
...
Result getOpenGLESGraphicsRequirementsKHR (
    SystemId systemId, GraphicsRequirementsOpenGLESKHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanInstanceExtensionsKHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVulkanInstanceExtensionsKHR (
    SystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<char>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanDeviceExtensionsKHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVulkanDeviceExtensionsKHR (
    SystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanGraphicsDeviceKHR>
 * 
...
Result getVulkanGraphicsDeviceKHR (
    SystemId systemId, VkInstance vkInstance, VkPhysicalDevice* vkPhysicalDevice, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<VkPhysicalDevice> getVulkanGraphicsDeviceKHR (
        SystemId systemId, VkInstance vkInstance, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VkPhysicalDevice getVulkanGraphicsDeviceKHR (
        SystemId systemId, VkInstance vkInstance, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanGraphicsRequirementsKHR>
 * 
...
Result getVulkanGraphicsRequirementsKHR (
    SystemId systemId, GraphicsRequirementsVulkanKHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetD3D11GraphicsRequirementsKHR>
 * 
...
Result getD3D11GraphicsRequirementsKHR (
    SystemId systemId, GraphicsRequirementsD3D11KHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetD3D12GraphicsRequirementsKHR>
 * 
...
Result getD3D12GraphicsRequirementsKHR (
    SystemId systemId, GraphicsRequirementsD3D12KHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrConvertWin32PerformanceCounterToTimeKHR>
 * 
...
Result convertWin32PerformanceCounterToTimeKHR (
    const LARGE_INTEGER* performanceCounter, Time time, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<Time> convertWin32PerformanceCounterToTimeKHR (
        const LARGE_INTEGER* performanceCounter, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Time convertWin32PerformanceCounterToTimeKHR (
        const LARGE_INTEGER* performanceCounter, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrConvertTimeToWin32PerformanceCounterKHR>
 * 
...
Result convertTimeToWin32PerformanceCounterKHR (
    Time time, LARGE_INTEGER* performanceCounter, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrConvertTimespecTimeToTimeKHR>
 * 
...
Result convertTimespecTimeToTimeKHR (
    const struct timespec* timespecTime, Time time, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Time convertTimespecTimeToTimeKHR (
        const struct timespec* timespecTime, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrConvertTimeToTimespecTimeKHR>
 * 
...
Result convertTimeToTimespecTimeKHR (
    Time time, struct timespec* timespecTime, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    timespec convertTimeToTimespecTimeKHR (
        Time time, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateVulkanInstanceKHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createVulkanInstanceKHR (
    const VulkanInstanceCreateInfoKHR& createInfo, VkInstance* vulkanInstance, VkResult* vulkanResult, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrCreateVulkanInstanceKHR enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateVulkanDeviceKHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createVulkanDeviceKHR (
    const VulkanDeviceCreateInfoKHR& createInfo, VkDevice* vulkanDevice, VkResult* vulkanResult, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrCreateVulkanDeviceKHR enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanGraphicsDevice2KHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVulkanGraphicsDevice2KHR (
    const VulkanGraphicsDeviceGetInfoKHR& getInfo, VkPhysicalDevice* vulkanPhysicalDevice, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<VkPhysicalDevice> getVulkanGraphicsDevice2KHR (
        const VulkanGraphicsDeviceGetInfoKHR& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VkPhysicalDevice getVulkanGraphicsDevice2KHR (
        const VulkanGraphicsDeviceGetInfoKHR& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVulkanGraphicsRequirements2KHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getVulkanGraphicsRequirements2KHR (
    SystemId systemId, GraphicsRequirementsVulkanKHR& graphicsRequirements, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetDebugUtilsObjectNameEXT>
 * 
...
Result setDebugUtilsObjectNameEXT (
    const DebugUtilsObjectNameInfoEXT& nameInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetDebugUtilsObjectNameEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateDebugUtilsMessengerEXT>
 * 
...
Result createDebugUtilsMessengerEXT (
    const DebugUtilsMessengerCreateInfoEXT& createInfo, DebugUtilsMessengerEXT& messenger, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<DebugUtilsMessengerEXT> createDebugUtilsMessengerEXT (
        const DebugUtilsMessengerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<DebugUtilsMessengerEXT, impl::RemoveRefConst<Dispatch>>> createDebugUtilsMessengerUniqueEXT (
        const DebugUtilsMessengerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    UniqueHandle<DebugUtilsMessengerEXT, impl::RemoveRefConst<Dispatch>> createDebugUtilsMessengerUniqueEXT (
        const DebugUtilsMessengerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSubmitDebugUtilsMessageEXT>
 * 
...
Result submitDebugUtilsMessageEXT (
    XrDebugUtilsMessageSeverityFlagsEXT messageSeverity, XrDebugUtilsMessageTypeFlagsEXT messageTypes, const DebugUtilsMessengerCallbackDataEXT& callbackData, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSubmitDebugUtilsMessageEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateReprojectionModesMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateReprojectionModesMSFT (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t modeCapacityInput, uint32_t* modeCountOutput, XrReprojectionModeMSFT* modes, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ReprojectionModeMSFT>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ReprojectionModeMSFT, Allocator>> enumerateReprojectionModesToVectorMSFT (
        SystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateReprojectionModesMSFT enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ReprojectionModeMSFT>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ReprojectionModeMSFT, Allocator>> enumerateReprojectionModesToVectorMSFT (
        SystemId systemId, ViewConfigurationType viewConfigurationType, Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSceneComputeFeaturesMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateSceneComputeFeaturesMSFT (
    SystemId systemId, uint32_t featureCapacityInput, uint32_t* featureCountOutput, XrSceneComputeFeatureMSFT* features, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SceneComputeFeatureMSFT>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SceneComputeFeatureMSFT, Allocator>> enumerateSceneComputeFeaturesToVectorMSFT (
        SystemId systemId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateSceneComputeFeaturesMSFT enhanced wrapper.
 * 
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SceneComputeFeatureMSFT>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SceneComputeFeatureMSFT, Allocator>> enumerateSceneComputeFeaturesToVectorMSFT (
        SystemId systemId, Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateViveTrackerPathsHTCX>
 * 
...
Result enumerateViveTrackerPathsHTCX (
    uint32_t pathCapacityInput, uint32_t* pathCountOutput, XrViveTrackerPathsHTCX* paths, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ViveTrackerPathsHTCX>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ViveTrackerPathsHTCX>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ViveTrackerPathsHTCX, Allocator>> enumerateViveTrackerPathsToVectorHTCX (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetAudioOutputDeviceGuidOculus>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getAudioOutputDeviceGuidOculus (
    wchar_t buffer[XR_MAX_AUDIO_DEVICE_STR_SIZE_OCULUS], Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetAudioOutputDeviceGuidOculus enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void getAudioOutputDeviceGuidOculus (
        wchar_t buffer[XR_MAX_AUDIO_DEVICE_STR_SIZE_OCULUS], Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetAudioInputDeviceGuidOculus>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getAudioInputDeviceGuidOculus (
    wchar_t buffer[XR_MAX_AUDIO_DEVICE_STR_SIZE_OCULUS], Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetAudioInputDeviceGuidOculus enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void getAudioInputDeviceGuidOculus (
        wchar_t buffer[XR_MAX_AUDIO_DEVICE_STR_SIZE_OCULUS], Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumeratePerformanceMetricsCounterPathsMETA>
 * 
...
Result enumeratePerformanceMetricsCounterPathsMETA (
    uint32_t counterPathCapacityInput, uint32_t* counterPathCountOutput, Path counterPaths, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<Path>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<Path>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<Path, Allocator>> enumeratePerformanceMetricsCounterPathsToVectorMETA (
        Allocator const& vectorAllocator, Dispatch&& d) const;
...
//! @}
 ...
 static_assert(sizeof(XrInstance) == sizeof(Instance), "Original type and wrapper have different size!"); 
 ...
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrInstance get(Instance const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrInstance handle in a Instance (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates Instance
 */
static OPENXR_HPP_INLINE XrInstance *put(Instance &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSession get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySession enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateReferenceSpaces>
 * 
 * @xrentity{xrEnumerateReferenceSpaces}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateReferenceSpaces (
    uint32_t spaceCapacityInput, uint32_t* spaceCountOutput, XrReferenceSpaceType* spaces, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateReferenceSpaces}
 */
    template <typename Allocator = std::allocator<ReferenceSpaceType>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrEnumerateReferenceSpaces}
 */
    template <typename Allocator = std::allocator<ReferenceSpaceType>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ReferenceSpaceType, Allocator>> enumerateReferenceSpacesToVector (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateReferenceSpace>
 * 
 * @xrentity{xrCreateReferenceSpace}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createReferenceSpace (
    const ReferenceSpaceCreateInfo& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Space> createReferenceSpace (
        const ReferenceSpaceCreateInfo& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetReferenceSpaceBoundsRect>
 * 
 * @xrentity{xrGetReferenceSpaceBoundsRect}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getReferenceSpaceBoundsRect (
    ReferenceSpaceType referenceSpaceType, Extent2Df& bounds, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrGetReferenceSpaceBoundsRect enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::SpaceBoundsUnavailable, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetReferenceSpaceBoundsRect>
 * 
 * @xrentity{xrGetReferenceSpaceBoundsRect}
...
Result createActionSpace (
    const ActionSpaceCreateInfo& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Space> createActionSpace (
        const ActionSpaceCreateInfo& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSwapchainFormats>
 * 
 * @xrentity{xrEnumerateSwapchainFormats}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateSwapchainFormats (
    uint32_t formatCapacityInput, uint32_t* formatCountOutput, int64_t* formats, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateSwapchainFormats}
 */
    template <typename Allocator = std::allocator<int64_t>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrEnumerateSwapchainFormats}
 */
    template <typename Allocator = std::allocator<int64_t>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<int64_t, Allocator>> enumerateSwapchainFormatsToVector (
        Allocator const& vectorAllocator, Dispatch&& d) const;
...
Result createSwapchain (
    const SwapchainCreateInfo& createInfo, Swapchain& swapchain, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Swapchain> createSwapchain (
        const SwapchainCreateInfo& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result beginSession (
    const SessionBeginInfo& beginInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrBeginSession enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrEndSession enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result requestExitSession (
    Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrRequestExitSession enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result waitFrame (
    const FrameWaitInfo& frameWaitInfo, FrameState& frameState, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<FrameState> waitFrame (
        const FrameWaitInfo& frameWaitInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result beginFrame (
    const FrameBeginInfo& frameBeginInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrBeginFrame enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::FrameDiscarded, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrBeginFrame>
 * 
 * @xrentity{xrBeginFrame}
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result endFrame (
    const FrameEndInfo& frameEndInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrEndFrame enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result locateViews (
    const ViewLocateInfo& viewLocateInfo, XrViewState* viewState, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrView* views, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrLocateViews}
 */
    template <typename Allocator = std::allocator<View>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<View, Allocator>> locateViewsToVector (
        const ViewLocateInfo& viewLocateInfo, XrViewState* viewState, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
/*!
 * @brief xrLocateViews enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 ...
 * @xrentity{xrLocateViews}
 */
    template <typename Allocator = std::allocator<View>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<View, Allocator>> locateViewsToVector (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrAttachSessionActionSets>
 * 
 * @xrentity{xrAttachSessionActionSets}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result attachSessionActionSets (
    const SessionActionSetsAttachInfo& attachInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrAttachSessionActionSets enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetCurrentInteractionProfile>
 * 
 * @xrentity{xrGetCurrentInteractionProfile}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getCurrentInteractionProfile (
    Path topLevelUserPath, InteractionProfileState& interactionProfile, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetActionStateBoolean>
 * 
 * @xrentity{xrGetActionStateBoolean}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getActionStateBoolean (
    const ActionStateGetInfo& getInfo, ActionStateBoolean& state, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ActionStateBoolean getActionStateBoolean (
        const ActionStateGetInfo& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
Result getActionStateFloat (
    const ActionStateGetInfo& getInfo, ActionStateFloat& state, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ActionStateFloat getActionStateFloat (
        const ActionStateGetInfo& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetActionStateVector2f>
 * 
 * @xrentity{xrGetActionStateVector2f}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getActionStateVector2f (
    const ActionStateGetInfo& getInfo, ActionStateVector2f& state, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
Result getActionStatePose (
    const ActionStateGetInfo& getInfo, ActionStatePose& state, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ActionStatePose getActionStatePose (
        const ActionStateGetInfo& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result syncActions (
    const ActionsSyncInfo& syncInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrSyncActions enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::SessionNotFocused, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSyncActions>
 * 
 * @xrentity{xrSyncActions}
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateBoundSourcesForAction>
 * 
 * @xrentity{xrEnumerateBoundSourcesForAction}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateBoundSourcesForAction (
    const BoundSourcesForActionEnumerateInfo& enumerateInfo, uint32_t sourceCapacityInput, uint32_t* sourceCountOutput, Path sources, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateBoundSourcesForAction}
 */
    template <typename Allocator = std::allocator<Path>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<Path, Allocator>> enumerateBoundSourcesForActionToVector (
        const BoundSourcesForActionEnumerateInfo& enumerateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateBoundSourcesForAction enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetInputSourceLocalizedName>
 * 
 * @xrentity{xrGetInputSourceLocalizedName}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getInputSourceLocalizedName (
    const InputSourceLocalizedNameGetInfo& getInfo, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<string_with_allocator<Allocator>> getInputSourceLocalizedName (
        const InputSourceLocalizedNameGetInfo& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
/*!
 * @brief xrGetInputSourceLocalizedName enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
...
Result applyHapticFeedback (
    const HapticActionInfo& hapticActionInfo, const XrHapticBaseHeader* hapticFeedback, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrApplyHapticFeedback enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::SessionNotFocused, or an error code if asserts are not active and exceptions are disabled)
...
Result stopHapticFeedback (
    const HapticActionInfo& hapticActionInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrStopHapticFeedback enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::SessionNotFocused, or an error code if asserts are not active and exceptions are disabled)
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetAndroidApplicationThreadKHR>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setAndroidApplicationThreadKHR (
    AndroidThreadTypeKHR threadType, uint32_t threadId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetAndroidApplicationThreadKHR enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setAndroidApplicationThreadKHR (
        AndroidThreadTypeKHR threadType, uint32_t threadId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSwapchainAndroidSurfaceKHR>
 * 
...
Result createSwapchainAndroidSurfaceKHR (
    const SwapchainCreateInfo& info, Swapchain& swapchain, jobject* surface, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<Swapchain> createSwapchainAndroidSurfaceKHR (
        const SwapchainCreateInfo& info, jobject* surface, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Swapchain createSwapchainAndroidSurfaceKHR (
        const SwapchainCreateInfo& info, jobject* surface, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<Swapchain, impl::RemoveRefConst<Dispatch>>> createSwapchainAndroidSurfaceUniqueKHR (
        const SwapchainCreateInfo& info, jobject* surface, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetVisibilityMaskKHR>
 * 
...
Result getVisibilityMaskKHR (
    ViewConfigurationType viewConfigurationType, uint32_t viewIndex, VisibilityMaskTypeKHR visibilityMaskType, VisibilityMaskKHR& visibilityMask, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<VisibilityMaskKHR> getVisibilityMaskKHR (
        ViewConfigurationType viewConfigurationType, uint32_t viewIndex, VisibilityMaskTypeKHR visibilityMaskType, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    VisibilityMaskKHR getVisibilityMaskKHR (
        ViewConfigurationType viewConfigurationType, uint32_t viewIndex, VisibilityMaskTypeKHR visibilityMaskType, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPerfSettingsSetPerformanceLevelEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result perfSettingsSetPerformanceLevelEXT (
    PerfSettingsDomainEXT domain, PerfSettingsLevelEXT level, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPerfSettingsSetPerformanceLevelEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void perfSettingsSetPerformanceLevelEXT (
        PerfSettingsDomainEXT domain, PerfSettingsLevelEXT level, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrThermalGetTemperatureTrendEXT>
 * 
...
Result thermalGetTemperatureTrendEXT (
    PerfSettingsDomainEXT domain, PerfSettingsNotificationLevelEXT& notificationLevel, float* tempHeadroom, float* tempSlope, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrThermalGetTemperatureTrendEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void thermalGetTemperatureTrendEXT (
        PerfSettingsDomainEXT domain, PerfSettingsNotificationLevelEXT& notificationLevel, float* tempHeadroom, float* tempSlope, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSessionBeginDebugUtilsLabelRegionEXT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSessionBeginDebugUtilsLabelRegionEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void sessionBeginDebugUtilsLabelRegionEXT (
        const DebugUtilsLabelEXT& labelInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSessionEndDebugUtilsLabelRegionEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result sessionEndDebugUtilsLabelRegionEXT (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSessionEndDebugUtilsLabelRegionEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void sessionEndDebugUtilsLabelRegionEXT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSessionInsertDebugUtilsLabelEXT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSessionInsertDebugUtilsLabelEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void sessionInsertDebugUtilsLabelEXT (
        const DebugUtilsLabelEXT& labelInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorMSFT>
 * 
...
Result createSpatialAnchorMSFT (
    const SpatialAnchorCreateInfoMSFT& createInfo, SpatialAnchorMSFT& anchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SpatialAnchorMSFT> createSpatialAnchorMSFT (
        const SpatialAnchorCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>>> createSpatialAnchorUniqueMSFT (
        const SpatialAnchorCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorSpaceMSFT>
 * 
...
Result createSpatialAnchorSpaceMSFT (
    const SpatialAnchorSpaceCreateInfoMSFT& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<Space> createSpatialAnchorSpaceMSFT (
        const SpatialAnchorSpaceCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Space createSpatialAnchorSpaceMSFT (
        const SpatialAnchorSpaceCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> createSpatialAnchorSpaceUniqueMSFT (
        const SpatialAnchorSpaceCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceActiveEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setInputDeviceActiveEXT (
    Path interactionProfile, Path topLevelPath, XrBool32 isActive, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetInputDeviceActiveEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateBoolEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setInputDeviceStateBoolEXT (
    Path topLevelPath, Path inputSourcePath, XrBool32 state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetInputDeviceStateBoolEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setInputDeviceStateBoolEXT (
        Path topLevelPath, Path inputSourcePath, XrBool32 state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateFloatEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setInputDeviceStateFloatEXT (
    Path topLevelPath, Path inputSourcePath, float state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetInputDeviceStateFloatEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setInputDeviceStateFloatEXT (
        Path topLevelPath, Path inputSourcePath, float state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceStateVector2fEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setInputDeviceStateVector2fEXT (
    Path topLevelPath, Path inputSourcePath, XrVector2f state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetInputDeviceStateVector2fEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setInputDeviceStateVector2fEXT (
        Path topLevelPath, Path inputSourcePath, XrVector2f state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetInputDeviceLocationEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setInputDeviceLocationEXT (
    Path topLevelPath, Path inputSourcePath, Space space, XrPosef pose, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetInputDeviceLocationEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setInputDeviceLocationEXT (
        Path topLevelPath, Path inputSourcePath, Space space, XrPosef pose, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandTrackerEXT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createHandTrackerEXT (
    const HandTrackerCreateInfoEXT& createInfo, HandTrackerEXT& handTracker, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<HandTrackerEXT> createHandTrackerEXT (
        const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    HandTrackerEXT createHandTrackerEXT (
        const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<HandTrackerEXT, impl::RemoveRefConst<Dispatch>>> createHandTrackerUniqueEXT (
        const HandTrackerCreateInfoEXT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorFromPerceptionAnchorMSFT>
 * 
...
Result createSpatialAnchorFromPerceptionAnchorMSFT (
    IUnknown* perceptionAnchor, SpatialAnchorMSFT& anchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>>> createSpatialAnchorFromPerceptionAnchorUniqueMSFT (
        IUnknown* perceptionAnchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>> createSpatialAnchorFromPerceptionAnchorUniqueMSFT (
        IUnknown* perceptionAnchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTryGetPerceptionAnchorFromSpatialAnchorMSFT>
 * 
...
Result tryGetPerceptionAnchorFromSpatialAnchorMSFT (
    SpatialAnchorMSFT anchor, IUnknown** perceptionAnchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTryGetPerceptionAnchorFromSpatialAnchorMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSceneObserverMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createSceneObserverMSFT (
    const SceneObserverCreateInfoMSFT& createInfo, SceneObserverMSFT& sceneObserver, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SceneObserverMSFT> createSceneObserverMSFT (
        const SceneObserverCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SceneObserverMSFT createSceneObserverMSFT (
        const SceneObserverCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<SceneObserverMSFT, impl::RemoveRefConst<Dispatch>>> createSceneObserverUniqueMSFT (
        const SceneObserverCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateDisplayRefreshRatesFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateDisplayRefreshRatesFB (
    uint32_t displayRefreshRateCapacityInput, uint32_t* displayRefreshRateCountOutput, float* displayRefreshRates, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<float>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<float>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<float, Allocator>> enumerateDisplayRefreshRatesToVectorFB (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetDisplayRefreshRateFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getDisplayRefreshRateFB (
    float* displayRefreshRate, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRequestDisplayRefreshRateFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result requestDisplayRefreshRateFB (
    float displayRefreshRate, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrRequestDisplayRefreshRateFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void requestDisplayRefreshRateFB (
        float displayRefreshRate, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateFacialTrackerHTC>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createFacialTrackerHTC (
    const FacialTrackerCreateInfoHTC& createInfo, FacialTrackerHTC& facialTracker, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<FacialTrackerHTC> createFacialTrackerHTC (
        const FacialTrackerCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    FacialTrackerHTC createFacialTrackerHTC (
        const FacialTrackerCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<FacialTrackerHTC, impl::RemoveRefConst<Dispatch>>> createFacialTrackerUniqueHTC (
        const FacialTrackerCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateColorSpacesFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateColorSpacesFB (
    uint32_t colorSpaceCapacityInput, uint32_t* colorSpaceCountOutput, XrColorSpaceFB* colorSpaces, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ColorSpaceFB>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<ColorSpaceFB>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ColorSpaceFB, Allocator>> enumerateColorSpacesToVectorFB (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setColorSpaceFB (
    ColorSpaceFB colorspace, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetColorSpaceFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createSpatialAnchorFB (
    const SpatialAnchorCreateInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<AsyncRequestIdFB> createSpatialAnchorFB (
        const SpatialAnchorCreateInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB createSpatialAnchorFB (
        const SpatialAnchorCreateInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateFoveationProfileFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createFoveationProfileFB (
    const FoveationProfileCreateInfoFB& createInfo, FoveationProfileFB& profile, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<FoveationProfileFB> createFoveationProfileFB (
        const FoveationProfileCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    FoveationProfileFB createFoveationProfileFB (
        const FoveationProfileCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<FoveationProfileFB, impl::RemoveRefConst<Dispatch>>> createFoveationProfileUniqueFB (
        const FoveationProfileCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrQuerySystemTrackedKeyboardFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result querySystemTrackedKeyboardFB (
    const KeyboardTrackingQueryFB& queryInfo, KeyboardTrackingDescriptionFB& keyboard, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<KeyboardTrackingDescriptionFB> querySystemTrackedKeyboardFB (
        const KeyboardTrackingQueryFB& queryInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateKeyboardSpaceFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createKeyboardSpaceFB (
    const KeyboardSpaceCreateInfoFB& createInfo, Space& keyboardSpace, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Space> createKeyboardSpaceFB (
        const KeyboardSpaceCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateTriangleMeshFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createTriangleMeshFB (
    const TriangleMeshCreateInfoFB& createInfo, TriangleMeshFB& outTriangleMesh, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<TriangleMeshFB> createTriangleMeshFB (
        const TriangleMeshCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    TriangleMeshFB createTriangleMeshFB (
        const TriangleMeshCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<TriangleMeshFB, impl::RemoveRefConst<Dispatch>>> createTriangleMeshUniqueFB (
        const TriangleMeshCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createPassthroughFB (
    const PassthroughCreateInfoFB& createInfo, PassthroughFB& outPassthrough, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<PassthroughFB> createPassthroughFB (
        const PassthroughCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PassthroughFB createPassthroughFB (
        const PassthroughCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<PassthroughFB, impl::RemoveRefConst<Dispatch>>> createPassthroughUniqueFB (
        const PassthroughCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreatePassthroughLayerFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createPassthroughLayerFB (
    const PassthroughLayerCreateInfoFB& createInfo, PassthroughLayerFB& outLayer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<PassthroughLayerFB> createPassthroughLayerFB (
        const PassthroughLayerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PassthroughLayerFB createPassthroughLayerFB (
        const PassthroughLayerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<PassthroughLayerFB, impl::RemoveRefConst<Dispatch>>> createPassthroughLayerUniqueFB (
        const PassthroughLayerCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateGeometryInstanceFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createGeometryInstanceFB (
    const GeometryInstanceCreateInfoFB& createInfo, GeometryInstanceFB& outGeometryInstance, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<GeometryInstanceFB> createGeometryInstanceFB (
        const GeometryInstanceCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    GeometryInstanceFB createGeometryInstanceFB (
        const GeometryInstanceCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<GeometryInstanceFB, impl::RemoveRefConst<Dispatch>>> createGeometryInstanceUniqueFB (
        const GeometryInstanceCreateInfoFB& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateRenderModelPathsFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateRenderModelPathsFB (
    uint32_t pathCapacityInput, uint32_t* pathCountOutput, XrRenderModelPathInfoFB* paths, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<RenderModelPathInfoFB>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<RenderModelPathInfoFB>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<RenderModelPathInfoFB, Allocator>> enumerateRenderModelPathsToVectorFB (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetRenderModelPropertiesFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getRenderModelPropertiesFB (
    Path path, RenderModelPropertiesFB& properties, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrGetRenderModelPropertiesFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::RenderModelUnavailableFB, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetRenderModelPropertiesFB>
 * 
 * @xrentity{xrGetRenderModelPropertiesFB}
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result loadRenderModelFB (
    const RenderModelLoadInfoFB& info, RenderModelBufferFB& buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrLoadRenderModelFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::RenderModelUnavailableFB, or an error code if asserts are not active and exceptions are disabled)
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetEnvironmentDepthEstimationVARJO>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setEnvironmentDepthEstimationVARJO (
    XrBool32 enabled, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetEnvironmentDepthEstimationVARJO enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setEnvironmentDepthEstimationVARJO (
        XrBool32 enabled, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetMarkerTrackingVARJO>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setMarkerTrackingVARJO (
    XrBool32 enabled, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetMarkerTrackingVARJO enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetMarkerTrackingTimeoutVARJO>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setMarkerTrackingTimeoutVARJO (
    uint64_t markerId, Duration timeout, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetMarkerTrackingTimeoutVARJO enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setMarkerTrackingTimeoutVARJO (
        uint64_t markerId, Duration timeout, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetMarkerTrackingPredictionVARJO>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setMarkerTrackingPredictionVARJO (
    uint64_t markerId, XrBool32 enabled, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetMarkerTrackingPredictionVARJO enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setMarkerTrackingPredictionVARJO (
        uint64_t markerId, XrBool32 enabled, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getMarkerSizeVARJO (
    uint64_t markerId, Extent2Df& size, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Extent2Df> getMarkerSizeVARJO (
        uint64_t markerId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateMarkerSpaceVARJO>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createMarkerSpaceVARJO (
    const MarkerSpaceCreateInfoVARJO& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Space> createMarkerSpaceVARJO (
        const MarkerSpaceCreateInfoVARJO& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setViewOffsetVARJO (
    float offset, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetViewOffsetVARJO enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorStoreConnectionMSFT>
 * 
...
Result createSpatialAnchorStoreConnectionMSFT (
    SpatialAnchorStoreConnectionMSFT& spatialAnchorStore, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<SpatialAnchorStoreConnectionMSFT, impl::RemoveRefConst<Dispatch>>> createSpatialAnchorStoreConnectionUniqueMSFT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    UniqueHandle<SpatialAnchorStoreConnectionMSFT, impl::RemoveRefConst<Dispatch>> createSpatialAnchorStoreConnectionUniqueMSFT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpatialAnchorFromPersistedNameMSFT>
 * 
...
Result createSpatialAnchorFromPersistedNameMSFT (
    const SpatialAnchorFromPersistedAnchorCreateInfoMSFT& spatialAnchorCreateInfo, SpatialAnchorMSFT& spatialAnchor, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SpatialAnchorMSFT> createSpatialAnchorFromPersistedNameMSFT (
        const SpatialAnchorFromPersistedAnchorCreateInfoMSFT& spatialAnchorCreateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>>> createSpatialAnchorFromPersistedNameUniqueMSFT (
        const SpatialAnchorFromPersistedAnchorCreateInfoMSFT& spatialAnchorCreateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>> createSpatialAnchorFromPersistedNameUniqueMSFT (
        const SpatialAnchorFromPersistedAnchorCreateInfoMSFT& spatialAnchorCreateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result querySpacesFB (
    const XrSpaceQueryInfoBaseHeaderFB* info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<AsyncRequestIdFB> querySpacesFB (
        const XrSpaceQueryInfoBaseHeaderFB* info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB querySpacesFB (
        const XrSpaceQueryInfoBaseHeaderFB* info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRetrieveSpaceQueryResultsFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result retrieveSpaceQueryResultsFB (
    AsyncRequestIdFB requestId, SpaceQueryResultsFB& results, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrRetrieveSpaceQueryResultsFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type SpaceQueryResultsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRetrieveSpaceQueryResultsFB>
 * 
 * @xrentity{xrRetrieveSpaceQueryResultsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SpaceQueryResultsFB> retrieveSpaceQueryResultsFB (
        AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type SpaceQueryResultsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRetrieveSpaceQueryResultsFB>
 * 
 * @xrentity{xrRetrieveSpaceQueryResultsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SpaceQueryResultsFB retrieveSpaceQueryResultsFB (
        AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result saveSpaceFB (
    const SpaceSaveInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<AsyncRequestIdFB> saveSpaceFB (
        const SpaceSaveInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result eraseSpaceFB (
    const SpaceEraseInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceBoundingBox2DFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceBoundingBox2DFB (
    Space space, Rect2Df& boundingBox2DOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Rect2Df getSpaceBoundingBox2DFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceBoundingBox3DFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceBoundingBox3DFB (
    Space space, Rect3DfFB& boundingBox3DOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Rect3DfFB getSpaceBoundingBox3DFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceSemanticLabelsFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceSemanticLabelsFB (
    Space space, SemanticLabelsFB& semanticLabelsOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetSpaceSemanticLabelsFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type SemanticLabelsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceSemanticLabelsFB>
 * 
 * @xrentity{xrGetSpaceSemanticLabelsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SemanticLabelsFB> getSpaceSemanticLabelsFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type SemanticLabelsFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceSemanticLabelsFB>
 * 
 * @xrentity{xrGetSpaceSemanticLabelsFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SemanticLabelsFB getSpaceSemanticLabelsFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceBoundary2DFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceBoundary2DFB (
    Space space, Boundary2DFB& boundary2DOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetSpaceBoundary2DFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type Boundary2DFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceBoundary2DFB>
 * 
 * @xrentity{xrGetSpaceBoundary2DFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Boundary2DFB> getSpaceBoundary2DFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type Boundary2DFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceBoundary2DFB>
 * 
 * @xrentity{xrGetSpaceBoundary2DFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    Boundary2DFB getSpaceBoundary2DFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceRoomLayoutFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceRoomLayoutFB (
    Space space, RoomLayoutFB& roomLayoutOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetSpaceRoomLayoutFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type RoomLayoutFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceRoomLayoutFB>
 * 
 * @xrentity{xrGetSpaceRoomLayoutFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<RoomLayoutFB> getSpaceRoomLayoutFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type RoomLayoutFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceRoomLayoutFB>
 * 
 * @xrentity{xrGetSpaceRoomLayoutFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    RoomLayoutFB getSpaceRoomLayoutFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetDigitalLensControlALMALENCE>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setDigitalLensControlALMALENCE (
    const DigitalLensControlALMALENCE& digitalLensControl, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetDigitalLensControlALMALENCE enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setDigitalLensControlALMALENCE (
        const DigitalLensControlALMALENCE& digitalLensControl, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceContainerFB (
    Space space, SpaceContainerFB& spaceContainerOutput, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetSpaceContainerFB enhanced wrapper.
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * @returns a ResultValue tuple containing:
 * - Result (which may be Result::Success, or an error code if asserts are not active )
 * - the output of type SpaceContainerFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceContainerFB>
 * 
 * @xrentity{xrGetSpaceContainerFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SpaceContainerFB> getSpaceContainerFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * Throws an appropriate exception on failure.
 * 
 * @returns the output of type SpaceContainerFB
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceContainerFB>
 * 
 * @xrentity{xrGetSpaceContainerFB}
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SpaceContainerFB getSpaceContainerFB (
        Space space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetPerformanceMetricsStateMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setPerformanceMetricsStateMETA (
    const PerformanceMetricsStateMETA& state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrSetPerformanceMetricsStateMETA enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void setPerformanceMetricsStateMETA (
        const PerformanceMetricsStateMETA& state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetPerformanceMetricsStateMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getPerformanceMetricsStateMETA (
    PerformanceMetricsStateMETA& state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrQueryPerformanceMetricsCounterMETA>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result queryPerformanceMetricsCounterMETA (
    Path counterPath, PerformanceMetricsCounterMETA& counter, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreatePassthroughHTC>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createPassthroughHTC (
    const PassthroughCreateInfoHTC& createInfo, PassthroughHTC& passthrough, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<PassthroughHTC> createPassthroughHTC (
        const PassthroughCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    PassthroughHTC createPassthroughHTC (
        const PassthroughCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UniqueHandle<PassthroughHTC, impl::RemoveRefConst<Dispatch>>> createPassthroughUniqueHTC (
        const PassthroughCreateInfoHTC& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result applyFoveationHTC (
    const FoveationApplyInfoHTC& applyInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrApplyFoveationHTC enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrSession) == sizeof(Session), "Original type and wrapper have different size!"); 
...
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSession handle in a Session (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates Session
 */
static OPENXR_HPP_INLINE XrSession *put(Session &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSpace get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result locateSpace (
    Space baseSpace, Time time, SpaceLocation& location, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SpaceLocation> locateSpace (
        Space baseSpace, Time time, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySpace enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceUuidFB (
    UuidEXT& uuid, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<UuidEXT> getSpaceUuidFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSpaceSupportedComponentsFB>
 * 
...
Result enumerateSpaceSupportedComponentsFB (
    uint32_t componentTypeCapacityInput, uint32_t* componentTypeCountOutput, XrSpaceComponentTypeFB* componentTypes, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SpaceComponentTypeFB>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SpaceComponentTypeFB, Allocator>> enumerateSpaceSupportedComponentsToVectorFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
/*!
 * @brief xrEnumerateSpaceSupportedComponentsFB enhanced wrapper.
 * 
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SpaceComponentTypeFB>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SpaceComponentTypeFB, Allocator>> enumerateSpaceSupportedComponentsToVectorFB (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrSetSpaceComponentStatusFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result setSpaceComponentStatusFB (
    const SpaceComponentStatusSetInfoFB& info, AsyncRequestIdFB requestId, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<AsyncRequestIdFB> setSpaceComponentStatusFB (
        const SpaceComponentStatusSetInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    AsyncRequestIdFB setSpaceComponentStatusFB (
        const SpaceComponentStatusSetInfoFB& info, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSpaceComponentStatusFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSpaceComponentStatusFB (
    SpaceComponentTypeFB componentType, SpaceComponentStatusFB& status, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSpace handle in a Space (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrAction get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyAction enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrAction handle in a Action (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates Action
 */
static OPENXR_HPP_INLINE XrAction *put(Action &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSwapchain get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySwapchain enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateSwapchainImages>
 * 
 * @xrentity{xrEnumerateSwapchainImages}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateSwapchainImages (
    uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 * @xrentity{xrEnumerateSwapchainImages}
 */
    template <typename ResultItemType, typename Allocator = std::allocator<ResultItemType>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrEnumerateSwapchainImages}
 */
    template <typename ResultItemType, typename Allocator = std::allocator<ResultItemType>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ResultItemType, Allocator>> enumerateSwapchainImagesToVector (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrAcquireSwapchainImage>
 * 
 * @xrentity{xrAcquireSwapchainImage}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result acquireSwapchainImage (
    const SwapchainImageAcquireInfo& acquireInfo, uint32_t* index, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<uint32_t> acquireSwapchainImage (
        const SwapchainImageAcquireInfo& acquireInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
...
Result waitSwapchainImage (
    const SwapchainImageWaitInfo& waitInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
/*!
 * @brief xrWaitSwapchainImage enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Throws an appropriate exception on failure if `OPENXR_HPP_NO_EXCEPTIONS` is not defined.
 * 
 * @returns Result (which may be Result::Success, Result::TimeoutExpired, or an error code if asserts are not active and exceptions are disabled)
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrWaitSwapchainImage>
 * 
 * @xrentity{xrWaitSwapchainImage}
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrReleaseSwapchainImage>
 * 
 * @xrentity{xrReleaseSwapchainImage}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result releaseSwapchainImage (
    const SwapchainImageReleaseInfo& releaseInfo, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrReleaseSwapchainImage enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result updateSwapchainFB (
    const XrSwapchainStateBaseHeaderFB* state, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrUpdateSwapchainFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrSwapchain) == sizeof(Swapchain), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSwapchain get(Swapchain const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSwapchain handle in a Swapchain (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates Swapchain
 */
static OPENXR_HPP_INLINE XrSwapchain *put(Swapchain &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrActionSet get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyActionSet enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createAction (
    const ActionCreateInfo& createInfo, Action& action, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Action> createAction (
...
//! @}
 ...
 static_assert(sizeof(XrActionSet) == sizeof(ActionSet), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrActionSet get(ActionSet const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrActionSet handle in a ActionSet (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates ActionSet
 */
static OPENXR_HPP_INLINE XrActionSet *put(ActionSet &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrDebugUtilsMessengerEXT>
 * 
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyDebugUtilsMessengerEXT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyDebugUtilsMessengerEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrDebugUtilsMessengerEXT) == sizeof(DebugUtilsMessengerEXT), "Original type and wrapper have different size!"); 

/*!
 * @brief Free function for getting the raw XrDebugUtilsMessengerEXT from an DebugUtilsMessengerEXT value.
 * 
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrDebugUtilsMessengerEXT get(DebugUtilsMessengerEXT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrDebugUtilsMessengerEXT handle in a DebugUtilsMessengerEXT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates DebugUtilsMessengerEXT
 */
static OPENXR_HPP_INLINE XrDebugUtilsMessengerEXT *put(DebugUtilsMessengerEXT &h, bool clear = true) noexcept { return h.put(clear); }
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSpatialAnchorMSFT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroySpatialAnchorMSFT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySpatialAnchorMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrSpatialAnchorMSFT) == sizeof(SpatialAnchorMSFT), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialAnchorMSFT get(SpatialAnchorMSFT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSpatialAnchorMSFT handle in a SpatialAnchorMSFT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates SpatialAnchorMSFT
 */
static OPENXR_HPP_INLINE XrSpatialAnchorMSFT *put(SpatialAnchorMSFT &h, bool clear = true) noexcept { return h.put(clear); }
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR HandTrackerEXT (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrHandTrackerEXT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyHandTrackerEXT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyHandTrackerEXT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result locateHandJointsEXT (
    const HandJointsLocateInfoEXT& locateInfo, HandJointLocationsEXT& locations, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<HandJointLocationsEXT> locateHandJointsEXT (
        const HandJointsLocateInfoEXT& locateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    HandJointLocationsEXT locateHandJointsEXT (
        const HandJointsLocateInfoEXT& locateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandMeshSpaceMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createHandMeshSpaceMSFT (
    const HandMeshSpaceCreateInfoMSFT& createInfo, Space& space, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Space> createHandMeshSpaceMSFT (
        const HandMeshSpaceCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result updateHandMeshMSFT (
    const HandMeshUpdateInfoMSFT& updateInfo, HandMeshMSFT& handMesh, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<HandMeshMSFT> updateHandMeshMSFT (
        const HandMeshUpdateInfoMSFT& updateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    HandMeshMSFT updateHandMeshMSFT (
        const HandMeshUpdateInfoMSFT& updateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getHandMeshFB (
    HandTrackingMeshFB& mesh, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    HandTrackingMeshFB getHandMeshFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrHandTrackerEXT) == sizeof(HandTrackerEXT), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrHandTrackerEXT get(HandTrackerEXT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrHandTrackerEXT handle in a HandTrackerEXT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates HandTrackerEXT
 */
static OPENXR_HPP_INLINE XrHandTrackerEXT *put(HandTrackerEXT &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between HandTrackerEXT values.
//! @relates HandTrackerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(HandTrackerEXT const& lhs, HandTrackerEXT const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between HandTrackerEXT values.
//! @relates HandTrackerEXT
...
//! @relates HandTrackerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(HandTrackerEXT const& lhs, XrHandTrackerEXT rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrHandTrackerEXT and HandTrackerEXT.
//! @relates HandTrackerEXT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrHandTrackerEXT lhs, HandTrackerEXT const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between HandTrackerEXT and raw XrHandTrackerEXT.
//! @relates HandTrackerEXT
 ...
 * @relates HandTrackerEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(HandTrackerEXT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates HandTrackerEXT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, HandTrackerEXT const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR SceneObserverMSFT (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSceneObserverMSFT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroySceneObserverMSFT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySceneObserverMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result createSceneMSFT (
    const SceneCreateInfoMSFT& createInfo, SceneMSFT& scene, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<SceneMSFT> createSceneMSFT (
        const SceneCreateInfoMSFT& createInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result computeNewSceneMSFT (
    const NewSceneComputeInfoMSFT& computeInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrComputeNewSceneMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDeserializeSceneMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result deserializeSceneMSFT (
    const SceneDeserializeInfoMSFT& deserializeInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDeserializeSceneMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrSceneObserverMSFT) == sizeof(SceneObserverMSFT), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSceneObserverMSFT get(SceneObserverMSFT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSceneObserverMSFT handle in a SceneObserverMSFT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates SceneObserverMSFT
 */
static OPENXR_HPP_INLINE XrSceneObserverMSFT *put(SceneObserverMSFT &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between SceneObserverMSFT values.
//! @relates SceneObserverMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SceneObserverMSFT const& lhs, SceneObserverMSFT const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between SceneObserverMSFT values.
//! @relates SceneObserverMSFT
...
//! @relates SceneObserverMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SceneObserverMSFT const& lhs, XrSceneObserverMSFT rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrSceneObserverMSFT and SceneObserverMSFT.
//! @relates SceneObserverMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSceneObserverMSFT lhs, SceneObserverMSFT const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between SceneObserverMSFT and raw XrSceneObserverMSFT.
//! @relates SceneObserverMSFT
 ...
 * @relates SceneObserverMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SceneObserverMSFT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates SceneObserverMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SceneObserverMSFT const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between SceneObserverMSFT and nullptr: true if the handle is not null.
 * @relates SceneObserverMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(SceneObserverMSFT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and SceneObserverMSFT: true if the handle is not null.
 * @relates SceneObserverMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, SceneObserverMSFT const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSceneMSFT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySceneMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneComponentsMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSceneComponentsMSFT (
    const SceneComponentsGetInfoMSFT& getInfo, SceneComponentsMSFT& components, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SceneComponentsMSFT> getSceneComponentsMSFT (
        const SceneComponentsGetInfoMSFT& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SceneComponentsMSFT getSceneComponentsMSFT (
        const SceneComponentsGetInfoMSFT& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrLocateSceneComponentsMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result locateSceneComponentsMSFT (
    const SceneComponentsLocateInfoMSFT& locateInfo, SceneComponentLocationsMSFT& locations, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SceneComponentLocationsMSFT> locateSceneComponentsMSFT (
        const SceneComponentsLocateInfoMSFT& locateInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSceneMeshBuffersMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSceneMeshBuffersMSFT (
    const SceneMeshBuffersGetInfoMSFT& getInfo, SceneMeshBuffersMSFT& buffers, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    ...
    ResultValue<SceneMeshBuffersMSFT> getSceneMeshBuffersMSFT (
        const SceneMeshBuffersGetInfoMSFT& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    SceneMeshBuffersMSFT getSceneMeshBuffersMSFT (
        const SceneMeshBuffersGetInfoMSFT& getInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetSerializedSceneFragmentDataMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getSerializedSceneFragmentDataMSFT (
    const SerializedSceneFragmentDataGetInfoMSFT& getInfo, uint32_t countInput, uint32_t* readOutput, uint8_t* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGetSerializedSceneFragmentDataMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void getSerializedSceneFragmentDataMSFT (
        const SerializedSceneFragmentDataGetInfoMSFT& getInfo, uint32_t countInput, uint32_t* readOutput, uint8_t* buffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrSceneMSFT) == sizeof(SceneMSFT), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSceneMSFT get(SceneMSFT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSceneMSFT handle in a SceneMSFT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates SceneMSFT
 */
static OPENXR_HPP_INLINE XrSceneMSFT *put(SceneMSFT &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between SceneMSFT values.
//! @relates SceneMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SceneMSFT const& lhs, SceneMSFT const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between SceneMSFT values.
//! @relates SceneMSFT
...
//! @relates SceneMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SceneMSFT const& lhs, XrSceneMSFT rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrSceneMSFT and SceneMSFT.
//! @relates SceneMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSceneMSFT lhs, SceneMSFT const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between SceneMSFT and raw XrSceneMSFT.
//! @relates SceneMSFT
 ...
 * @relates SceneMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SceneMSFT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates SceneMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SceneMSFT const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR FacialTrackerHTC (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrFacialTrackerHTC get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyFacialTrackerHTC>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyFacialTrackerHTC enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetFacialExpressionsHTC>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result getFacialExpressionsHTC (
    FacialExpressionsHTC& facialExpressions, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrFacialTrackerHTC) == sizeof(FacialTrackerHTC), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrFacialTrackerHTC get(FacialTrackerHTC const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrFacialTrackerHTC handle in a FacialTrackerHTC (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates FacialTrackerHTC
 */
static OPENXR_HPP_INLINE XrFacialTrackerHTC *put(FacialTrackerHTC &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between FacialTrackerHTC values.
//! @relates FacialTrackerHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FacialTrackerHTC const& lhs, FacialTrackerHTC const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between FacialTrackerHTC values.
//! @relates FacialTrackerHTC
...
//! @relates FacialTrackerHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FacialTrackerHTC const& lhs, XrFacialTrackerHTC rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrFacialTrackerHTC and FacialTrackerHTC.
//! @relates FacialTrackerHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrFacialTrackerHTC lhs, FacialTrackerHTC const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between FacialTrackerHTC and raw XrFacialTrackerHTC.
//! @relates FacialTrackerHTC
 ...
 * @relates FacialTrackerHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(FacialTrackerHTC const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates FacialTrackerHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, FacialTrackerHTC const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between FacialTrackerHTC and nullptr: true if the handle is not null.
 * @relates FacialTrackerHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(FacialTrackerHTC const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and FacialTrackerHTC: true if the handle is not null.
 * @relates FacialTrackerHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, FacialTrackerHTC const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR FoveationProfileFB (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrFoveationProfileFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyFoveationProfileFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyFoveationProfileFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrFoveationProfileFB) == sizeof(FoveationProfileFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrFoveationProfileFB get(FoveationProfileFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrFoveationProfileFB handle in a FoveationProfileFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates FoveationProfileFB
 */
static OPENXR_HPP_INLINE XrFoveationProfileFB *put(FoveationProfileFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between FoveationProfileFB values.
//! @relates FoveationProfileFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FoveationProfileFB const& lhs, FoveationProfileFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between FoveationProfileFB values.
//! @relates FoveationProfileFB
...
//! @relates FoveationProfileFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(FoveationProfileFB const& lhs, XrFoveationProfileFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrFoveationProfileFB and FoveationProfileFB.
//! @relates FoveationProfileFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrFoveationProfileFB lhs, FoveationProfileFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between FoveationProfileFB and raw XrFoveationProfileFB.
//! @relates FoveationProfileFB
 ...
 * @relates FoveationProfileFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(FoveationProfileFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates FoveationProfileFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, FoveationProfileFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between FoveationProfileFB and nullptr: true if the handle is not null.
 * @relates FoveationProfileFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(FoveationProfileFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and FoveationProfileFB: true if the handle is not null.
 * @relates FoveationProfileFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, FoveationProfileFB const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR TriangleMeshFB (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrTriangleMeshFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyTriangleMeshFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyTriangleMeshFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshGetVertexBufferFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result triangleMeshGetVertexBufferFB (
    XrVector3f** outVertexBuffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTriangleMeshGetVertexBufferFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void triangleMeshGetVertexBufferFB (
        XrVector3f** outVertexBuffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshGetIndexBufferFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result triangleMeshGetIndexBufferFB (
    uint32_t** outIndexBuffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTriangleMeshGetIndexBufferFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void triangleMeshGetIndexBufferFB (
        uint32_t** outIndexBuffer, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshBeginUpdateFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result triangleMeshBeginUpdateFB (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTriangleMeshBeginUpdateFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void triangleMeshBeginUpdateFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshEndUpdateFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result triangleMeshEndUpdateFB (
    uint32_t vertexCount, uint32_t triangleCount, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTriangleMeshEndUpdateFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshBeginVertexBufferUpdateFB>
 * 
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrTriangleMeshEndVertexBufferUpdateFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrTriangleMeshEndVertexBufferUpdateFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void triangleMeshEndVertexBufferUpdateFB (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrTriangleMeshFB) == sizeof(TriangleMeshFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrTriangleMeshFB get(TriangleMeshFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrTriangleMeshFB handle in a TriangleMeshFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates TriangleMeshFB
 */
static OPENXR_HPP_INLINE XrTriangleMeshFB *put(TriangleMeshFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between TriangleMeshFB values.
//! @relates TriangleMeshFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(TriangleMeshFB const& lhs, TriangleMeshFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between TriangleMeshFB values.
//! @relates TriangleMeshFB
...
//! @relates TriangleMeshFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(TriangleMeshFB const& lhs, XrTriangleMeshFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrTriangleMeshFB and TriangleMeshFB.
//! @relates TriangleMeshFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrTriangleMeshFB lhs, TriangleMeshFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between TriangleMeshFB and raw XrTriangleMeshFB.
//! @relates TriangleMeshFB
 ...
 * @relates TriangleMeshFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(TriangleMeshFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates TriangleMeshFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, TriangleMeshFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrPassthroughFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyPassthroughFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyPassthroughFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result passthroughStartFB (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughStartFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result passthroughPauseFB (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughPauseFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrPassthroughFB) == sizeof(PassthroughFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrPassthroughFB get(PassthroughFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrPassthroughFB handle in a PassthroughFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates PassthroughFB
 */
static OPENXR_HPP_INLINE XrPassthroughFB *put(PassthroughFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between PassthroughFB values.
//! @relates PassthroughFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughFB const& lhs, PassthroughFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between PassthroughFB values.
//! @relates PassthroughFB
...
//! @relates PassthroughFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughFB const& lhs, XrPassthroughFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrPassthroughFB and PassthroughFB.
//! @relates PassthroughFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrPassthroughFB lhs, PassthroughFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between PassthroughFB and raw XrPassthroughFB.
//! @relates PassthroughFB
 ...
 * @relates PassthroughFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(PassthroughFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates PassthroughFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, PassthroughFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR PassthroughLayerFB (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrPassthroughLayerFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyPassthroughLayerFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyPassthroughLayerFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPassthroughLayerPauseFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result passthroughLayerPauseFB (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughLayerPauseFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPassthroughLayerResumeFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result passthroughLayerResumeFB (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughLayerResumeFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPassthroughLayerSetStyleFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result passthroughLayerSetStyleFB (
    const PassthroughStyleFB& style, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughLayerSetStyleFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void passthroughLayerSetStyleFB (
        const PassthroughStyleFB& style, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPassthroughLayerSetKeyboardHandsIntensityFB>
 * 
...
Result passthroughLayerSetKeyboardHandsIntensityFB (
    const PassthroughKeyboardHandsIntensityFB& intensity, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPassthroughLayerSetKeyboardHandsIntensityFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrPassthroughLayerFB) == sizeof(PassthroughLayerFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrPassthroughLayerFB get(PassthroughLayerFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrPassthroughLayerFB handle in a PassthroughLayerFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates PassthroughLayerFB
 */
static OPENXR_HPP_INLINE XrPassthroughLayerFB *put(PassthroughLayerFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between PassthroughLayerFB values.
//! @relates PassthroughLayerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughLayerFB const& lhs, PassthroughLayerFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between PassthroughLayerFB values.
//! @relates PassthroughLayerFB
...
//! @relates PassthroughLayerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughLayerFB const& lhs, XrPassthroughLayerFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrPassthroughLayerFB and PassthroughLayerFB.
//! @relates PassthroughLayerFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrPassthroughLayerFB lhs, PassthroughLayerFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between PassthroughLayerFB and raw XrPassthroughLayerFB.
//! @relates PassthroughLayerFB
 ...
 * @relates PassthroughLayerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(PassthroughLayerFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates PassthroughLayerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, PassthroughLayerFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between PassthroughLayerFB and nullptr: true if the handle is not null.
 * @relates PassthroughLayerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(PassthroughLayerFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and PassthroughLayerFB: true if the handle is not null.
 * @relates PassthroughLayerFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, PassthroughLayerFB const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR GeometryInstanceFB (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrGeometryInstanceFB get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyGeometryInstanceFB>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyGeometryInstanceFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGeometryInstanceSetTransformFB>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result geometryInstanceSetTransformFB (
    const GeometryInstanceTransformFB& transformation, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrGeometryInstanceSetTransformFB enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void geometryInstanceSetTransformFB (
        const GeometryInstanceTransformFB& transformation, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrGeometryInstanceFB) == sizeof(GeometryInstanceFB), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrGeometryInstanceFB get(GeometryInstanceFB const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrGeometryInstanceFB handle in a GeometryInstanceFB (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates GeometryInstanceFB
 */
static OPENXR_HPP_INLINE XrGeometryInstanceFB *put(GeometryInstanceFB &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between GeometryInstanceFB values.
//! @relates GeometryInstanceFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(GeometryInstanceFB const& lhs, GeometryInstanceFB const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between GeometryInstanceFB values.
//! @relates GeometryInstanceFB
...
//! @relates GeometryInstanceFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(GeometryInstanceFB const& lhs, XrGeometryInstanceFB rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrGeometryInstanceFB and GeometryInstanceFB.
//! @relates GeometryInstanceFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrGeometryInstanceFB lhs, GeometryInstanceFB const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between GeometryInstanceFB and raw XrGeometryInstanceFB.
//! @relates GeometryInstanceFB
 ...
 * @relates GeometryInstanceFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(GeometryInstanceFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates GeometryInstanceFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, GeometryInstanceFB const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between GeometryInstanceFB and nullptr: true if the handle is not null.
 * @relates GeometryInstanceFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(GeometryInstanceFB const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and GeometryInstanceFB: true if the handle is not null.
 * @relates GeometryInstanceFB
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, GeometryInstanceFB const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSpatialAnchorStoreConnectionMSFT>
 * 
 ...
 * Explicit on 32-bit platforms by default unless `OPENXR_HPP_TYPESAFE_CONVERSION` is defined.
 */
OPENXR_HPP_TYPESAFE_EXPLICIT SpatialAnchorStoreConnectionMSFT (RawHandleType handle) noexcept : val_(handle) {}
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR SpatialAnchorStoreConnectionMSFT (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrSpatialAnchorStoreConnectionMSFT get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroySpatialAnchorStoreConnectionMSFT>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroySpatialAnchorStoreConnectionMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrPersistSpatialAnchorMSFT>
 * 
...
Result persistSpatialAnchorMSFT (
    const SpatialAnchorPersistenceInfoMSFT& spatialAnchorPersistenceInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrPersistSpatialAnchorMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumeratePersistedSpatialAnchorNamesMSFT>
 * 
...
Result enumeratePersistedSpatialAnchorNamesMSFT (
    uint32_t spatialAnchorNamesCapacityInput, uint32_t* spatialAnchorNamesCountOutput, XrSpatialAnchorPersistenceNameMSFT* persistedAnchorNames, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SpatialAnchorPersistenceNameMSFT>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SpatialAnchorPersistenceNameMSFT, Allocator>> enumeratePersistedSpatialAnchorNamesToVectorMSFT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
/*!
 * @brief xrEnumeratePersistedSpatialAnchorNamesMSFT enhanced wrapper.
 * 
 ...
 * @note Non-core function: needs a dynamic dispatch.
 */
    template <typename Allocator = std::allocator<SpatialAnchorPersistenceNameMSFT>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<SpatialAnchorPersistenceNameMSFT, Allocator>> enumeratePersistedSpatialAnchorNamesToVectorMSFT (
        Allocator const& vectorAllocator, Dispatch&& d) const;
 ...
 */
    template <typename Allocator = std::allocator<SpatialAnchorPersistenceNameMSFT>, typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    std::vector<SpatialAnchorPersistenceNameMSFT, Allocator> enumeratePersistedSpatialAnchorNamesToVectorMSFT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
/*!
 * @brief xrEnumeratePersistedSpatialAnchorNamesMSFT enhanced wrapper.
 * 
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrUnpersistSpatialAnchorMSFT>
 * 
...
Result unpersistSpatialAnchorMSFT (
    const SpatialAnchorPersistenceNameMSFT& spatialAnchorPersistenceName, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrUnpersistSpatialAnchorMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrClearSpatialAnchorStoreMSFT>
 * 
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result clearSpatialAnchorStoreMSFT (
    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrClearSpatialAnchorStoreMSFT enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    void clearSpatialAnchorStoreMSFT (
        Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
//! @}
 ...
 static_assert(sizeof(XrSpatialAnchorStoreConnectionMSFT) == sizeof(SpatialAnchorStoreConnectionMSFT), "Original type and wrapper have different size!"); 

/*!
 * @brief Free function for getting the raw XrSpatialAnchorStoreConnectionMSFT from an SpatialAnchorStoreConnectionMSFT value.
 * 
 * @found_by_adl
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrSpatialAnchorStoreConnectionMSFT get(SpatialAnchorStoreConnectionMSFT const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrSpatialAnchorStoreConnectionMSFT handle in a SpatialAnchorStoreConnectionMSFT (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates SpatialAnchorStoreConnectionMSFT
 */
static OPENXR_HPP_INLINE XrSpatialAnchorStoreConnectionMSFT *put(SpatialAnchorStoreConnectionMSFT &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between SpatialAnchorStoreConnectionMSFT values.
//! @relates SpatialAnchorStoreConnectionMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpatialAnchorStoreConnectionMSFT const& lhs, SpatialAnchorStoreConnectionMSFT const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between SpatialAnchorStoreConnectionMSFT values.
//! @relates SpatialAnchorStoreConnectionMSFT
...
//! @brief `<` comparison between SpatialAnchorStoreConnectionMSFT and raw XrSpatialAnchorStoreConnectionMSFT.
//! @relates SpatialAnchorStoreConnectionMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(SpatialAnchorStoreConnectionMSFT const& lhs, XrSpatialAnchorStoreConnectionMSFT rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrSpatialAnchorStoreConnectionMSFT and SpatialAnchorStoreConnectionMSFT.
//! @relates SpatialAnchorStoreConnectionMSFT
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrSpatialAnchorStoreConnectionMSFT lhs, SpatialAnchorStoreConnectionMSFT const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between SpatialAnchorStoreConnectionMSFT and raw XrSpatialAnchorStoreConnectionMSFT.
//! @relates SpatialAnchorStoreConnectionMSFT
...
/*!
 * @brief Equality comparison between SpatialAnchorStoreConnectionMSFT and nullptr: true if the handle is null.
 * @relates SpatialAnchorStoreConnectionMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(SpatialAnchorStoreConnectionMSFT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Equality comparison between nullptr and SpatialAnchorStoreConnectionMSFT: true if the handle is null.
 * @relates SpatialAnchorStoreConnectionMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SpatialAnchorStoreConnectionMSFT const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 * @brief Inequality comparison between SpatialAnchorStoreConnectionMSFT and nullptr: true if the handle is not null.
 * @relates SpatialAnchorStoreConnectionMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(SpatialAnchorStoreConnectionMSFT const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() != XR_NULL_HANDLE;
...
/*!
 * @brief Inequality comparison between nullptr and SpatialAnchorStoreConnectionMSFT: true if the handle is not null.
 * @relates SpatialAnchorStoreConnectionMSFT
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, SpatialAnchorStoreConnectionMSFT const &rhs) noexcept {
    return rhs.get() != XR_NULL_HANDLE;
...
//! Constructor from nullptr - creates empty/null handle.
OPENXR_HPP_CONSTEXPR PassthroughHTC (std::nullptr_t /* unused */) noexcept : val_(XR_NULL_HANDLE) {}
 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrPassthroughHTC get() const noexcept {
        return val_;
    }
/*!
 * @brief "Put" function for assigning as null (by default) then getting the address of the raw pointer to pass to creation functions.
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyPassthroughHTC>
 * 
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrDestroyPassthroughHTC enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
...
//! @}
 ...
 static_assert(sizeof(XrPassthroughHTC) == sizeof(PassthroughHTC), "Original type and wrapper have different size!"); 
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrPassthroughHTC get(PassthroughHTC const& v) noexcept { return v.get(); }
/*!
 * @brief Free "put" function for clearing (by default) and getting the address of the raw XrPassthroughHTC handle in a PassthroughHTC (by
 * reference).
 * 
 * e.g.
 * ```
 ...
 * @relates PassthroughHTC
 */
static OPENXR_HPP_INLINE XrPassthroughHTC *put(PassthroughHTC &h, bool clear = true) noexcept { return h.put(clear); }

//! @brief `<` comparison between PassthroughHTC values.
//! @relates PassthroughHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughHTC const& lhs, PassthroughHTC const& rhs) noexcept {
    return lhs.get()<rhs.get();
}
//! @brief `>` comparison between PassthroughHTC values.
//! @relates PassthroughHTC
...
//! @relates PassthroughHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(PassthroughHTC const& lhs, XrPassthroughHTC rhs) noexcept {
    return lhs.get()<rhs;
}
//! @brief `<` comparison between raw XrPassthroughHTC and PassthroughHTC.
//! @relates PassthroughHTC
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator<(XrPassthroughHTC lhs, PassthroughHTC const& rhs) noexcept {
    return lhs<rhs.get();
}
//! @brief `>` comparison between PassthroughHTC and raw XrPassthroughHTC.
//! @relates PassthroughHTC
 ...
 * @relates PassthroughHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(PassthroughHTC const &lhs, std::nullptr_t /* unused */) noexcept {
    return lhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * @relates PassthroughHTC
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, PassthroughHTC const &rhs) noexcept {
    return rhs.get() == XR_NULL_HANDLE;
}
/*!
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateApiLayerProperties>
 * 
 * @xrentity{xrEnumerateApiLayerProperties}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateApiLayerProperties (
    uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrApiLayerProperties* properties, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) ;
 ...
 * @xrentity{xrEnumerateApiLayerProperties}
 */
    template <typename Allocator = std::allocator<ApiLayerProperties>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
 ...
 * @xrentity{xrEnumerateApiLayerProperties}
 */
    template <typename Allocator = std::allocator<ApiLayerProperties>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ApiLayerProperties, Allocator>> enumerateApiLayerPropertiesToVector (
 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrEnumerateInstanceExtensionProperties>
 * 
 * @xrentity{xrEnumerateInstanceExtensionProperties}
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result enumerateInstanceExtensionProperties (
    const char* layerName, uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrExtensionProperties* properties, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) ;
 ...
 * @xrentity{xrEnumerateInstanceExtensionProperties}
 */
    template <typename Allocator = std::allocator<ExtensionProperties>, typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ExtensionProperties, Allocator>> enumerateInstanceExtensionPropertiesToVector (
 ...
 * @xrentity{xrEnumerateInstanceExtensionProperties}
 */
    template <typename Allocator = std::allocator<ExtensionProperties>, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<std::vector<ExtensionProperties, Allocator>> enumerateInstanceExtensionPropertiesToVector (
...
Result createInstance (
    const InstanceCreateInfo& createInfo, Instance& instance, Dispatch&& d OPENXR_HPP_DEFAULT_CORE_DISPATCH_ARG) ;
 ...
 */
    template <typename Dispatch OPENXR_HPP_DEFAULT_CORE_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
    ResultValue<Instance> createInstance (
 ...
 */
template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
Result initializeLoaderKHR (
    const XrLoaderInitInfoBaseHeaderKHR* loaderInitInfo, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) ;

#else  // OPENXR_HPP_DISABLE_ENHANCED_MODE
#ifdef OPENXR_HPP_NO_EXCEPTIONS
/*!
 * @brief xrInitializeLoaderKHR enhanced wrapper (hides basic wrapper unless `OPENXR_HPP_DISABLE_ENHANCED_MODE` defined).
 * 
 * Will not throw exceptions. This overload is only available when `OPENXR_HPP_NO_EXCEPTIONS` is defined.
 * 
 * Asserts that the result is Result::Success.
