...
namespace OPENXR_HPP_NAMESPACE
{
    ...
    public:
        ...
        /*!
         * @brief Returns the address of the raw XrAsyncRequestIdFB value,
         * for use in creation/assignment.
         */
        XrAsyncRequestIdFB *put() noexcept
        {
            return &val_;
        }
        //! @}
    ...
    /*!
     * @brief Free function for getting the address of the raw XrAsyncRequestIdFB from an AsyncRequestIdFB value.
     *
     * @found_by_adl
     ...
     * @ingroup utility_accessors
     */
    static OPENXR_HPP_INLINE XrAsyncRequestIdFB *put(AsyncRequestIdFB &v) noexcept { return v.put(); }
    ...
    public:
        ...
        {
            if (clear)
                val_ = XR_NULL_RENDER_MODEL_KEY_FB;
            return &val_;
        }
        //! @}
