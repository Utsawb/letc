 ...
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSceneComputeFeatureMSFT>
 * 
...
enum class SceneComputeFeatureMSFT: int32_t {
 ...
 static_assert(sizeof(SceneComputeFeatureMSFT) == sizeof(XrSceneComputeFeatureMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrSceneComputeFeatureMSFT value from a SceneComputeFeatureMSFT.
 * 
 * @found_by_adl
 * @see SceneComputeFeatureMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSceneComputeFeatureMSFT get(SceneComputeFeatureMSFT const& v) {
    return static_cast<XrSceneComputeFeatureMSFT>(v);
}

/*!
 * @brief Free function for retrieving the string name of a SceneComputeFeatureMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see SceneComputeFeatureMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SceneComputeFeatureMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a SceneComputeFeatureMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see SceneComputeFeatureMSFT
 */
 ...
 * Provided by the `XR_MSFT_scene_understanding` extension.
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSceneComputeConsistencyMSFT>
 * 
...
enum class SceneComputeConsistencyMSFT: int32_t {
 ...
 static_assert(sizeof(SceneComputeConsistencyMSFT) == sizeof(XrSceneComputeConsistencyMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrSceneComputeConsistencyMSFT value from a SceneComputeConsistencyMSFT.
 * 
 * @found_by_adl
 * @see SceneComputeConsistencyMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSceneComputeConsistencyMSFT get(SceneComputeConsistencyMSFT const& v) {
    return static_cast<XrSceneComputeConsistencyMSFT>(v);
}

/*!
 * @brief Free function for retrieving the string name of a SceneComputeConsistencyMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see SceneComputeConsistencyMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SceneComputeConsistencyMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a SceneComputeConsistencyMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see SceneComputeConsistencyMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR std::string to_string(SceneComputeConsistencyMSFT value) {
    return {to_string_literal(value)};
}
//! @}
...
enum class MeshComputeLodMSFT: int32_t {
 ...
 static_assert(sizeof(MeshComputeLodMSFT) == sizeof(XrMeshComputeLodMSFT), "Original type and wrapper have different size!"); 
 ...
 * @see MeshComputeLodMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(MeshComputeLodMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a MeshComputeLodMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see MeshComputeLodMSFT
 */
 ...
 * Provided by the `XR_MSFT_scene_understanding` extension.
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSceneComponentTypeMSFT>
 * 
...
enum class SceneComponentTypeMSFT: int32_t {
 ...
 static_assert(sizeof(SceneComponentTypeMSFT) == sizeof(XrSceneComponentTypeMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrSceneComponentTypeMSFT value from a SceneComponentTypeMSFT.
 * 
 * @found_by_adl
 * @see SceneComponentTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSceneComponentTypeMSFT get(SceneComponentTypeMSFT const& v) {
    return static_cast<XrSceneComponentTypeMSFT>(v);
}

/*!
 * @brief Free function for retrieving the string name of a SceneComponentTypeMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see SceneComponentTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SceneComponentTypeMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a SceneComponentTypeMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see SceneComponentTypeMSFT
 */
...
enum class SceneObjectTypeMSFT: int32_t {
 ...
 static_assert(sizeof(SceneObjectTypeMSFT) == sizeof(XrSceneObjectTypeMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrSceneObjectTypeMSFT value from a SceneObjectTypeMSFT.
 * 
 * @found_by_adl
...
/*!
 * @brief Free function for retrieving the string name of a SceneObjectTypeMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see SceneObjectTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SceneObjectTypeMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a SceneObjectTypeMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see SceneObjectTypeMSFT
 */
 ...
 * Provided by the `XR_MSFT_scene_understanding` extension.
 * 
 * @see <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrScenePlaneAlignmentTypeMSFT>
 * 
...
enum class ScenePlaneAlignmentTypeMSFT: int32_t {
 ...
 static_assert(sizeof(ScenePlaneAlignmentTypeMSFT) == sizeof(XrScenePlaneAlignmentTypeMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrScenePlaneAlignmentTypeMSFT value from a ScenePlaneAlignmentTypeMSFT.
 * 
 * @found_by_adl
 * @see ScenePlaneAlignmentTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrScenePlaneAlignmentTypeMSFT get(ScenePlaneAlignmentTypeMSFT const& v) {
    return static_cast<XrScenePlaneAlignmentTypeMSFT>(v);
}

/*!
 * @brief Free function for retrieving the string name of a ScenePlaneAlignmentTypeMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see ScenePlaneAlignmentTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(ScenePlaneAlignmentTypeMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a ScenePlaneAlignmentTypeMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see ScenePlaneAlignmentTypeMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR std::string to_string(ScenePlaneAlignmentTypeMSFT value) {
    return {to_string_literal(value)};
}
//! @}
...
enum class SceneComputeStateMSFT: int32_t {
 ...
 static_assert(sizeof(SceneComputeStateMSFT) == sizeof(XrSceneComputeStateMSFT), "Original type and wrapper have different size!"); 

//! @addtogroup utility_accessors
//! @{
/*!
 * @brief Free function for retrieving the raw XrSceneComputeStateMSFT value from a SceneComputeStateMSFT.
 * 
 * @found_by_adl
...
/*!
 * @brief Free function for retrieving the string name of a SceneComputeStateMSFT value as a const char *.
 * 
 * @found_by_adl
 * @see SceneComputeStateMSFT
 */
OPENXR_HPP_INLINE OPENXR_HPP_SWITCH_CONSTEXPR const char* to_string_literal(SceneComputeStateMSFT value) {
    switch (value) {
...
/*!
 * @brief Free function for retrieving the string name of a SceneComputeStateMSFT value as a std::string.
 * 
 * @found_by_adl
 * @see SceneComputeStateMSFT
 */
