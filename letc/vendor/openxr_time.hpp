 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrTime get() const noexcept {
        return val_;
    }
/*!
...
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw XrTime from an Time value.
 * 
 * @found_by_adl
 * @see Time::put( )
 * @relates Time
