 ...
 */
    ...
    OPENXR_HPP_CONSTEXPR XrDuration get() const noexcept {
        return val_;
    }
/*!
...
static OPENXR_HPP_CONSTEXPR Duration minHaptic() noexcept { return Duration{XR_MIN_HAPTIC_DURATION}; }
 ...
 static_assert(sizeof(XrDuration) == sizeof(Duration), "Original type and wrapper have different size!"); 
...
/*!
 * @brief Free function for clearing (by default) and getting the address of the raw XrDuration from an Duration value.
 * 
 * @found_by_adl
 * @see Duration::put( )
 * @relates Duration
 * @ingroup utility_accessors
 */
static OPENXR_HPP_INLINE XrDuration *put(Duration &v, bool clear = true) noexcept { return v.put(clear); }
