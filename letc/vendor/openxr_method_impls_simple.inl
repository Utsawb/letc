...
OPENXR_HPP_INLINE Result enumerateApiLayerProperties (
    uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrApiLayerProperties* properties, Dispatch&& d)  {
...
OPENXR_HPP_INLINE Result enumerateInstanceExtensionProperties (
    const char* layerName, uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrExtensionProperties* properties, Dispatch&& d)  {
...
OPENXR_HPP_INLINE Result Instance::enumerateEnvironmentBlendModes (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateEnvironmentBlendModes(this->get(), systemId.get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), environmentBlendModeCapacityInput, environmentBlendModeCountOutput, environmentBlendModes) );
...
OPENXR_HPP_INLINE Result Instance::enumerateViewConfigurations (
    SystemId systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurations(this->get(), systemId.get(), viewConfigurationTypeCapacityInput, viewConfigurationTypeCountOutput, viewConfigurationTypes) );
...
OPENXR_HPP_INLINE Result Instance::enumerateViewConfigurationViews (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), systemId.get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, viewCountOutput, views) );
...
OPENXR_HPP_INLINE Result Swapchain::enumerateSwapchainImages (
    uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images, Dispatch&& d) const {
...
OPENXR_HPP_INLINE Result Session::locateViews (
    ...
    Result result = static_cast<Result>( d.xrLocateViews(this->get(), viewLocateInfo.get(), viewState, viewCapacityInput, viewCountOutput, views) );
...
OPENXR_HPP_INLINE Result Session::enumerateBoundSourcesForAction (
    ...
    Result result = static_cast<Result>( d.xrEnumerateBoundSourcesForAction(this->get(), enumerateInfo.get(), sourceCapacityInput, sourceCountOutput, sources.get()) );
...
OPENXR_HPP_INLINE Result Session::getVisibilityMaskKHR (
    ...
    Result result = static_cast<Result>( d.xrGetVisibilityMaskKHR(this->get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewIndex, OPENXR_HPP_NAMESPACE::get(visibilityMaskType), visibilityMask.put()) );
...
OPENXR_HPP_INLINE Result Instance::convertWin32PerformanceCounterToTimeKHR (
    ...
    Result result = static_cast<Result>( d.xrConvertWin32PerformanceCounterToTimeKHR(this->get(), performanceCounter, time.get()) );
...
OPENXR_HPP_INLINE Result Instance::convertTimespecTimeToTimeKHR (
    ...
    Result result = static_cast<Result>( d.xrConvertTimespecTimeToTimeKHR(this->get(), timespecTime, time.get()) );
...
OPENXR_HPP_INLINE Result HandTrackerEXT::locateHandJointsEXT (
    ...
    Result result = static_cast<Result>( d.xrLocateHandJointsEXT(this->get(), locateInfo.get(), locations.put()) );
...
OPENXR_HPP_INLINE Result Instance::enumerateReprojectionModesMSFT (
    SystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t modeCapacityInput, uint32_t* modeCountOutput, XrReprojectionModeMSFT* modes, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateReprojectionModesMSFT(this->get(), systemId.get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), modeCapacityInput, modeCountOutput, modes) );
...
OPENXR_HPP_INLINE Result Instance::enumerateSceneComputeFeaturesMSFT (
    SystemId systemId, uint32_t featureCapacityInput, uint32_t* featureCountOutput, XrSceneComputeFeatureMSFT* features, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateSceneComputeFeaturesMSFT(this->get(), systemId.get(), featureCapacityInput, featureCountOutput, features) );
...
OPENXR_HPP_INLINE Result SceneMSFT::getSceneComponentsMSFT (
    ...
    Result result = static_cast<Result>( d.xrGetSceneComponentsMSFT(this->get(), getInfo.get(), components.put()) );
...
OPENXR_HPP_INLINE Result SceneMSFT::locateSceneComponentsMSFT (
    ...
    Result result = static_cast<Result>( d.xrLocateSceneComponentsMSFT(this->get(), locateInfo.get(), locations.put()) );
...
OPENXR_HPP_INLINE Result Instance::enumerateViveTrackerPathsHTCX (
    uint32_t pathCapacityInput, uint32_t* pathCountOutput, XrViveTrackerPathsHTCX* paths, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateViveTrackerPathsHTCX(this->get(), pathCapacityInput, pathCountOutput, paths) );
...
OPENXR_HPP_INLINE Result FacialTrackerHTC::getFacialExpressionsHTC (
    ...
    Result result = static_cast<Result>( d.xrGetFacialExpressionsHTC(this->get(), facialExpressions.put()) );
...
OPENXR_HPP_INLINE Result Session::enumerateColorSpacesFB (
    uint32_t colorSpaceCapacityInput, uint32_t* colorSpaceCountOutput, XrColorSpaceFB* colorSpaces, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateColorSpacesFB(this->get(), colorSpaceCapacityInput, colorSpaceCountOutput, colorSpaces) );
...
OPENXR_HPP_INLINE Result Session::createSpatialAnchorFB (
    ...
    Result result = static_cast<Result>( d.xrCreateSpatialAnchorFB(this->get(), info.get(), requestId.get()) );
...
OPENXR_HPP_INLINE Result Space::getSpaceUuidFB (
    UuidEXT& uuid, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrGetSpaceUuidFB(this->get(), uuid.put()) );
...
OPENXR_HPP_INLINE Result Space::enumerateSpaceSupportedComponentsFB (
    uint32_t componentTypeCapacityInput, uint32_t* componentTypeCountOutput, XrSpaceComponentTypeFB* componentTypes, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateSpaceSupportedComponentsFB(this->get(), componentTypeCapacityInput, componentTypeCountOutput, componentTypes) );
...
OPENXR_HPP_INLINE Result Space::setSpaceComponentStatusFB (
    ...
    Result result = static_cast<Result>( d.xrSetSpaceComponentStatusFB(this->get(), info.get(), requestId.get()) );
...
OPENXR_HPP_INLINE Result Session::enumerateRenderModelPathsFB (
    uint32_t pathCapacityInput, uint32_t* pathCountOutput, XrRenderModelPathInfoFB* paths, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumerateRenderModelPathsFB(this->get(), pathCapacityInput, pathCountOutput, paths) );
...
OPENXR_HPP_INLINE Result SpatialAnchorStoreConnectionMSFT::enumeratePersistedSpatialAnchorNamesMSFT (
    uint32_t spatialAnchorNamesCapacityInput, uint32_t* spatialAnchorNamesCountOutput, XrSpatialAnchorPersistenceNameMSFT* persistedAnchorNames, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrEnumeratePersistedSpatialAnchorNamesMSFT(this->get(), spatialAnchorNamesCapacityInput, spatialAnchorNamesCountOutput, persistedAnchorNames) );
...
OPENXR_HPP_INLINE Result Session::querySpacesFB (
    const XrSpaceQueryInfoBaseHeaderFB* info, AsyncRequestIdFB requestId, Dispatch&& d) const {
    
    Result result = static_cast<Result>( d.xrQuerySpacesFB(this->get(), info, requestId.get()) );
...
OPENXR_HPP_INLINE Result Session::retrieveSpaceQueryResultsFB (
    ...
    Result result = static_cast<Result>( d.xrRetrieveSpaceQueryResultsFB(this->get(), requestId.get(), results.put()) );
...
OPENXR_HPP_INLINE Result Session::saveSpaceFB (
    ...
    Result result = static_cast<Result>( d.xrSaveSpaceFB(this->get(), info.get(), requestId.get()) );
...
OPENXR_HPP_INLINE Result Session::eraseSpaceFB (
    ...
    Result result = static_cast<Result>( d.xrEraseSpaceFB(this->get(), info.get(), requestId.get()) );
...
OPENXR_HPP_INLINE Result Session::getSpaceSemanticLabelsFB (
    ...
    Result result = static_cast<Result>( d.xrGetSpaceSemanticLabelsFB(this->get(), space.get(), semanticLabelsOutput.put()) );
...
OPENXR_HPP_INLINE Result Session::getSpaceBoundary2DFB (
    ...
    Result result = static_cast<Result>( d.xrGetSpaceBoundary2DFB(this->get(), space.get(), boundary2DOutput.put()) );
...
OPENXR_HPP_INLINE Result Session::getSpaceRoomLayoutFB (
    ...
    Result result = static_cast<Result>( d.xrGetSpaceRoomLayoutFB(this->get(), space.get(), roomLayoutOutput.put()) );
...
OPENXR_HPP_INLINE Result Session::getSpaceContainerFB (
    ...
    Result result = static_cast<Result>( d.xrGetSpaceContainerFB(this->get(), space.get(), spaceContainerOutput.put()) );
...
OPENXR_HPP_INLINE Result Instance::enumeratePerformanceMetricsCounterPathsMETA (
    ...
    Result result = static_cast<Result>( d.xrEnumeratePerformanceMetricsCounterPathsMETA(this->get(), counterPathCapacityInput, counterPathCountOutput, counterPaths.get()) );
