...
//! @brief Exception class for the Result::ErrorValidationFailure aka XR_ERROR_VALIDATION_FAILURE result code.
...
//! @brief Exception class for the Result::ErrorRuntimeFailure aka XR_ERROR_RUNTIME_FAILURE result code.
...
//! @brief Exception class for the Result::ErrorOutOfMemory aka XR_ERROR_OUT_OF_MEMORY result code.
...
//! @brief Exception class for the Result::ErrorAPIVersionUnsupported aka XR_ERROR_API_VERSION_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorInitializationFailed aka XR_ERROR_INITIALIZATION_FAILED result code.
...
//! @brief Exception class for the Result::ErrorFunctionUnsupported aka XR_ERROR_FUNCTION_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorFeatureUnsupported aka XR_ERROR_FEATURE_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorExtensionNotPresent aka XR_ERROR_EXTENSION_NOT_PRESENT result code.
...
//! @brief Exception class for the Result::ErrorLimitReached aka XR_ERROR_LIMIT_REACHED result code.
...
//! @brief Exception class for the Result::ErrorSizeInsufficient aka XR_ERROR_SIZE_INSUFFICIENT result code.
...
//! @brief Exception class for the Result::ErrorHandleInvalid aka XR_ERROR_HANDLE_INVALID result code.
...
//! @brief Exception class for the Result::ErrorInstanceLost aka XR_ERROR_INSTANCE_LOST result code.
...
//! @brief Exception class for the Result::ErrorSessionRunning aka XR_ERROR_SESSION_RUNNING result code.
...
//! @brief Exception class for the Result::ErrorSessionNotRunning aka XR_ERROR_SESSION_NOT_RUNNING result code.
...
//! @brief Exception class for the Result::ErrorSystemInvalid aka XR_ERROR_SYSTEM_INVALID result code.
...
//! @brief Exception class for the Result::ErrorPathCountExceeded aka XR_ERROR_PATH_COUNT_EXCEEDED result code.
...
//! @brief Exception class for the Result::ErrorPathFormatInvalid aka XR_ERROR_PATH_FORMAT_INVALID result code.
...
//! @brief Exception class for the Result::ErrorPathUnsupported aka XR_ERROR_PATH_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorLayerInvalid aka XR_ERROR_LAYER_INVALID result code.
...
//! @brief Exception class for the Result::ErrorLayerLimitExceeded aka XR_ERROR_LAYER_LIMIT_EXCEEDED result code.
...
//! @brief Exception class for the Result::ErrorSwapchainRectInvalid aka XR_ERROR_SWAPCHAIN_RECT_INVALID result code.
...
//! @brief Exception class for the Result::ErrorSwapchainFormatUnsupported aka XR_ERROR_SWAPCHAIN_FORMAT_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorActionTypeMismatch aka XR_ERROR_ACTION_TYPE_MISMATCH result code.
...
//! @brief Exception class for the Result::ErrorSessionNotReady aka XR_ERROR_SESSION_NOT_READY result code.
...
//! @brief Exception class for the Result::ErrorSessionNotStopping aka XR_ERROR_SESSION_NOT_STOPPING result code.
...
//! @brief Exception class for the Result::ErrorReferenceSpaceUnsupported aka XR_ERROR_REFERENCE_SPACE_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorFileAccessError aka XR_ERROR_FILE_ACCESS_ERROR result code.
...
//! @brief Exception class for the Result::ErrorFileContentsInvalid aka XR_ERROR_FILE_CONTENTS_INVALID result code.
...
//! @brief Exception class for the Result::ErrorFormFactorUnsupported aka XR_ERROR_FORM_FACTOR_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorFormFactorUnavailable aka XR_ERROR_FORM_FACTOR_UNAVAILABLE result code.
...
//! @brief Exception class for the Result::ErrorAPILayerNotPresent aka XR_ERROR_API_LAYER_NOT_PRESENT result code.
...
//! @brief Exception class for the Result::ErrorCallOrderInvalid aka XR_ERROR_CALL_ORDER_INVALID result code.
...
//! @brief Exception class for the Result::ErrorGraphicsDeviceInvalid aka XR_ERROR_GRAPHICS_DEVICE_INVALID result code.
...
//! @brief Exception class for the Result::ErrorIndexOutOfRange aka XR_ERROR_INDEX_OUT_OF_RANGE result code.
...
//! @brief Exception class for the Result::ErrorViewConfigurationTypeUnsupported aka XR_ERROR_VIEW_CONFIGURATION_TYPE_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorEnvironmentBlendModeUnsupported aka XR_ERROR_ENVIRONMENT_BLEND_MODE_UNSUPPORTED result code.
...
//! @brief Exception class for the Result::ErrorNameDuplicated aka XR_ERROR_NAME_DUPLICATED result code.
...
//! @brief Exception class for the Result::ErrorActionsetNotAttached aka XR_ERROR_ACTIONSET_NOT_ATTACHED result code.
...
//! @brief Exception class for the Result::ErrorActionsetsAlreadyAttached aka XR_ERROR_ACTIONSETS_ALREADY_ATTACHED result code.
...
//! @brief Exception class for the Result::ErrorLocalizedNameDuplicated aka XR_ERROR_LOCALIZED_NAME_DUPLICATED result code.
...
//! @brief Exception class for the Result::ErrorLocalizedNameInvalid aka XR_ERROR_LOCALIZED_NAME_INVALID result code.
...
//! @brief Exception class for the Result::ErrorGraphicsRequirementsCallMissing aka XR_ERROR_GRAPHICS_REQUIREMENTS_CALL_MISSING result code.
class GraphicsRequirementsCallMissingError : public SystemError {
   public:
    GraphicsRequirementsCallMissingError (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorGraphicsRequirementsCallMissing), message){}
...
//! @brief Exception class for the Result::ErrorRuntimeUnavailable aka XR_ERROR_RUNTIME_UNAVAILABLE result code.
...
//! @brief Exception class for the Result::ErrorAndroidThreadSettingsIdInvalidKHR aka XR_ERROR_ANDROID_THREAD_SETTINGS_ID_INVALID_KHR result code.
...
#ifdef XR_KHR_android_thread_settings
//! @brief Exception class for the Result::ErrorAndroidThreadSettingsFailureKHR aka XR_ERROR_ANDROID_THREAD_SETTINGS_FAILURE_KHR result code.
...
//! @brief Exception class for the Result::ErrorCreateSpatialAnchorFailedMSFT aka XR_ERROR_CREATE_SPATIAL_ANCHOR_FAILED_MSFT result code.
...
//! @brief Exception class for the Result::ErrorSecondaryViewConfigurationTypeNotEnabledMSFT aka XR_ERROR_SECONDARY_VIEW_CONFIGURATION_TYPE_NOT_ENABLED_MSFT result code.
class SecondaryViewConfigurationTypeNotEnabledErrorMSFT : public SystemError {
   public:
    SecondaryViewConfigurationTypeNotEnabledErrorMSFT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSecondaryViewConfigurationTypeNotEnabledMSFT), message){}
...
//! @brief Exception class for the Result::ErrorControllerModelKeyInvalidMSFT aka XR_ERROR_CONTROLLER_MODEL_KEY_INVALID_MSFT result code.
...
//! @brief Exception class for the Result::ErrorReprojectionModeUnsupportedMSFT aka XR_ERROR_REPROJECTION_MODE_UNSUPPORTED_MSFT result code.
class ReprojectionModeUnsupportedErrorMSFT : public SystemError {
   public:
    ReprojectionModeUnsupportedErrorMSFT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorReprojectionModeUnsupportedMSFT), message){}
...
//! @brief Exception class for the Result::ErrorComputeNewSceneNotCompletedMSFT aka XR_ERROR_COMPUTE_NEW_SCENE_NOT_COMPLETED_MSFT result code.
class ComputeNewSceneNotCompletedErrorMSFT : public SystemError {
   public:
    ComputeNewSceneNotCompletedErrorMSFT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorComputeNewSceneNotCompletedMSFT), message){}
...
#ifdef XR_MSFT_scene_understanding
//! @brief Exception class for the Result::ErrorSceneComponentIdInvalidMSFT aka XR_ERROR_SCENE_COMPONENT_ID_INVALID_MSFT result code.
...
#endif  // XR_MSFT_scene_understanding
#ifdef XR_MSFT_scene_understanding
//! @brief Exception class for the Result::ErrorSceneComponentTypeMismatchMSFT aka XR_ERROR_SCENE_COMPONENT_TYPE_MISMATCH_MSFT result code.
...
#endif  // XR_MSFT_scene_understanding
#ifdef XR_MSFT_scene_understanding
//! @brief Exception class for the Result::ErrorSceneMeshBufferIdInvalidMSFT aka XR_ERROR_SCENE_MESH_BUFFER_ID_INVALID_MSFT result code.
...
#endif  // XR_MSFT_scene_understanding
#ifdef XR_MSFT_scene_understanding
//! @brief Exception class for the Result::ErrorSceneComputeFeatureIncompatibleMSFT aka XR_ERROR_SCENE_COMPUTE_FEATURE_INCOMPATIBLE_MSFT result code.
class SceneComputeFeatureIncompatibleErrorMSFT : public SystemError {
   public:
    SceneComputeFeatureIncompatibleErrorMSFT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSceneComputeFeatureIncompatibleMSFT), message){}
...
#endif  // XR_MSFT_scene_understanding
#ifdef XR_MSFT_scene_understanding
//! @brief Exception class for the Result::ErrorSceneComputeConsistencyMismatchMSFT aka XR_ERROR_SCENE_COMPUTE_CONSISTENCY_MISMATCH_MSFT result code.
class SceneComputeConsistencyMismatchErrorMSFT : public SystemError {
   public:
    SceneComputeConsistencyMismatchErrorMSFT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSceneComputeConsistencyMismatchMSFT), message){}
...
//! @brief Exception class for the Result::ErrorDisplayRefreshRateUnsupportedFB aka XR_ERROR_DISPLAY_REFRESH_RATE_UNSUPPORTED_FB result code.
class DisplayRefreshRateUnsupportedErrorFB : public SystemError {
   public:
    DisplayRefreshRateUnsupportedErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorDisplayRefreshRateUnsupportedFB), message){}
...
//! @brief Exception class for the Result::ErrorColorSpaceUnsupportedFB aka XR_ERROR_COLOR_SPACE_UNSUPPORTED_FB result code.
...
//! @brief Exception class for the Result::ErrorSpaceComponentNotSupportedFB aka XR_ERROR_SPACE_COMPONENT_NOT_SUPPORTED_FB result code.
class SpaceComponentNotSupportedErrorFB : public SystemError {
   public:
    SpaceComponentNotSupportedErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentNotSupportedFB), message){}

    SpaceComponentNotSupportedErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentNotSupportedFB), message) {}
};
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_spatial_entity
//! @brief Exception class for the Result::ErrorSpaceComponentNotEnabledFB aka XR_ERROR_SPACE_COMPONENT_NOT_ENABLED_FB result code.
class SpaceComponentNotEnabledErrorFB : public SystemError {
   public:
    SpaceComponentNotEnabledErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentNotEnabledFB), message){}

    SpaceComponentNotEnabledErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentNotEnabledFB), message) {}
};
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_spatial_entity
//! @brief Exception class for the Result::ErrorSpaceComponentStatusPendingFB aka XR_ERROR_SPACE_COMPONENT_STATUS_PENDING_FB result code.
class SpaceComponentStatusPendingErrorFB : public SystemError {
   public:
    SpaceComponentStatusPendingErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentStatusPendingFB), message){}

    SpaceComponentStatusPendingErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentStatusPendingFB), message) {}
};
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_spatial_entity
//! @brief Exception class for the Result::ErrorSpaceComponentStatusAlreadySetFB aka XR_ERROR_SPACE_COMPONENT_STATUS_ALREADY_SET_FB result code.
class SpaceComponentStatusAlreadySetErrorFB : public SystemError {
   public:
    SpaceComponentStatusAlreadySetErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentStatusAlreadySetFB), message){}

    SpaceComponentStatusAlreadySetErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentStatusAlreadySetFB), message) {}
};
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorUnexpectedStatePassthroughFB aka XR_ERROR_UNEXPECTED_STATE_PASSTHROUGH_FB result code.
...
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorFeatureAlreadyCreatedPassthroughFB aka XR_ERROR_FEATURE_ALREADY_CREATED_PASSTHROUGH_FB result code.
class FeatureAlreadyCreatedPassthroughErrorFB : public SystemError {
   public:
    FeatureAlreadyCreatedPassthroughErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorFeatureAlreadyCreatedPassthroughFB), message){}
...
#endif  // XR_FB_passthrough
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorFeatureRequiredPassthroughFB aka XR_ERROR_FEATURE_REQUIRED_PASSTHROUGH_FB result code.
...
#endif  // XR_FB_passthrough
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorNotPermittedPassthroughFB aka XR_ERROR_NOT_PERMITTED_PASSTHROUGH_FB result code.
...
#endif  // XR_FB_passthrough
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorInsufficientResourcesPassthroughFB aka XR_ERROR_INSUFFICIENT_RESOURCES_PASSTHROUGH_FB result code.
class InsufficientResourcesPassthroughErrorFB : public SystemError {
   public:
    InsufficientResourcesPassthroughErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorInsufficientResourcesPassthroughFB), message){}
...
#endif  // XR_FB_passthrough
#ifdef XR_FB_passthrough
//! @brief Exception class for the Result::ErrorUnknownPassthroughFB aka XR_ERROR_UNKNOWN_PASSTHROUGH_FB result code.
...
//! @brief Exception class for the Result::ErrorRenderModelKeyInvalidFB aka XR_ERROR_RENDER_MODEL_KEY_INVALID_FB result code.
...
//! @brief Exception class for the Result::ErrorMarkerNotTrackedVARJO aka XR_ERROR_MARKER_NOT_TRACKED_VARJO result code.
...
#ifdef XR_VARJO_marker_tracking
//! @brief Exception class for the Result::ErrorMarkerIdInvalidVARJO aka XR_ERROR_MARKER_ID_INVALID_VARJO result code.
...
//! @brief Exception class for the Result::ErrorSpatialAnchorNameNotFoundMSFT aka XR_ERROR_SPATIAL_ANCHOR_NAME_NOT_FOUND_MSFT result code.
...
#ifdef XR_MSFT_spatial_anchor_persistence
//! @brief Exception class for the Result::ErrorSpatialAnchorNameInvalidMSFT aka XR_ERROR_SPATIAL_ANCHOR_NAME_INVALID_MSFT result code.
...
OPENXR_HPP_INLINE void throwResultException(Result result, char const* message) {
    switch (result) {
        ...
        case Result::ErrorSpaceComponentNotSupportedFB:
            throw SpaceComponentNotSupportedErrorFB (message);
            #endif  // XR_FB_spatial_entity

        #ifdef XR_FB_spatial_entity
        case Result::ErrorSpaceComponentNotEnabledFB:
            throw SpaceComponentNotEnabledErrorFB (message);
            #endif  // XR_FB_spatial_entity

        #ifdef XR_FB_spatial_entity
        case Result::ErrorSpaceComponentStatusPendingFB:
            throw SpaceComponentStatusPendingErrorFB (message);
            #endif  // XR_FB_spatial_entity

        #ifdef XR_FB_spatial_entity
        case Result::ErrorSpaceComponentStatusAlreadySetFB:
            throw SpaceComponentStatusAlreadySetErrorFB (message);
            #endif  // XR_FB_spatial_entity
